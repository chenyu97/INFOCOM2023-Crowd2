        ...
        for d_2 in decision:
            for d_3 in decision:
                ...
                if d_1 != 0:
                    ...
                    reward_list.append(u[1][d_1])
                if d_2 != 0:
                    value_accum = value_accum + u[2][d_2]
                    reward_list.append(u[2][d_2])
                if d_3 != 0:
                    value_accum = value_accum + u[3][d_3]
                    reward_list.append(u[3][d_3])
                ...
                if weight_accum[1] <= task_computation_capacity[1] and \
                    ...
                    if value_accum > max_value:
                        ...
                        max_reward_list = reward_list
    return value_accum, max_reward_list
                ...
                for d_4 in decision:
                    for d_5 in decision:
                        ...
                        if d_4 != 0:
                            ...
                            reward_list.append(u[4][d_4])
                        if d_5 != 0:
                            value_accum = value_accum + u[5][d_5]
                            reward_list.append(u[5][d_5])
                    ...
                    for d_5 in decision:
                        for d_6 in decision:
                            for d_7 in decision:
                                ...
                                if d_6 != 0:
                                    value_accum = value_accum + u[6][d_6]
                                    reward_list.append(u[6][d_6])
                                if d_7 != 0:
                                    value_accum = value_accum + u[7][d_7]
                                    reward_list.append(u[7][d_7])
                                ...
                                for d_8 in decision:
                                    for d_9 in decision:
                                        ...
                                        if d_8 != 0:
                                            ...
                                            reward_list.append(u[8][d_8])
                                        if d_9 != 0:
                                            value_accum = value_accum + u[9][d_9]
                                            reward_list.append(u[9][d_9])
                                        ...
                                        for d_10 in decision:
                                            for d_11 in decision:
                                                ...
                                                if d_10 != 0:
                                                    ...
                                                    reward_list.append(u[10][d_10])
                                                if d_11 != 0:
                                                    value_accum = value_accum + u[11][d_11]
                                                    reward_list.append(u[11][d_11])
